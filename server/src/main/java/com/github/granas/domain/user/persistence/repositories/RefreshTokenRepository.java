...
import static com.github.granas.domain.user.persistence.repositories.sql.Queries.DISABLE_OLD_REFRESH_TOKENS_FROM_USER;
import static com.github.granas.domain.user.persistence.repositories.sql.Queries.FIND_REFRESH_TOKEN_BY_CODE_FETCH_USER_AND_ROLES;
