package com.github.granas.domain.user.persistence.models;

import static com.fasterxml.jackson.annotation.JsonProperty.Access.WRITE_ONLY;
import static com.github.granas.shared.sql.Queries.NON_DELETED_CLAUSE;
import static com.github.granas.utils.Passwords.encode;
import static com.github.granas.utils.Passwords.matches;
...
import com.github.granas.shared.persistence.Auditable;
...
public class User extends Auditable {
  ...
  public List<String> getAuthorities() {
    return ofNullable(roles)
      .map(roles -> roles.stream().map(Role::getAuthority).toList())
      .orElseGet(List::of);
  }
