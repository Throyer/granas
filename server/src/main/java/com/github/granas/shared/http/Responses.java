package com.github.granas.shared.http;
...
import com.github.granas.utils.JSON;
...
public class Responses {
  ...
  public static void forbidden(HttpServletRequest request, HttpServletResponse response, AuthenticationException exception) {
    forbidden(response);
  }
