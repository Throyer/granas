...
import static com.github.throyer.granas.domain.user.i18n.Messages.EMAIL_UNAVAILABLE_MESSAGE;
import static com.github.throyer.granas.domain.user.persistence.models.Role.USER;
import static com.github.throyer.granas.shared.http.Responses.conflict;
import static com.github.throyer.granas.shared.http.Responses.internalServerError;

import org.springframework.stereotype.Service;

import com.github.throyer.granas.domain.user.dtos.CreateUserData;
import com.github.throyer.granas.domain.user.persistence.models.User;
import com.github.throyer.granas.domain.user.persistence.repositories.RoleRepository;
